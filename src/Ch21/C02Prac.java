...
public class C02Prac {
	 ...
	 public static void main(String[] args) {
	        ...
	        // 한 개의 정수와 한 개의 문자열을 갖는 Pair 객체 생성
	        Pair<Integer, String>  intStringpair= new Pair<>(10000, "Hi");
	        System.out.println("First Element: " + intStringpair.getFirst());
	        System.out.println("Second Element: " + intStringpair.getSecond());
	        System.out.println();
	    }
